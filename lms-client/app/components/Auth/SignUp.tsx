...
const SignUp: FC<Props> = ({ setRoute }) => {
  ...
  const [activate, { data: activationData, isSuccess: activationSuccess, error: activationError }] = useActivationMutation();
...
useEffect(() => {
  ...
  }, [isSuccess, error, activationError, activationSuccess]);
